 ...
 * @author Madhumitha
 */
public class PostGIS_queries_D1_Topo {
 ...
 */
   ...
   /**
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Connection c = null;
       Statement stmt = null;
       PrintStream out = new PrintStream(new FileOutputStream("src/adbproject/output_PostGIS_D1_topo.txt"));
       ...
       Class.forName("org.postgresql.Driver");
         ...
         double total;
         double used;
            FileReader reader = new FileReader("src/adbproject/Topo_PostGIS_D1");
