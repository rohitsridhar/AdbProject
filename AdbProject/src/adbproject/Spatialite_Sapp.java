 ...
 */
    ...
    public static void main(String[] args) throws ClassNotFoundException, FileNotFoundException, IOException {
        PrintStream out = new PrintStream(new FileOutputStream("src/adbproject/Sappoutput_spatialite.txt"));
        System.setOut(out);
        long startTime=0;
        long stopTime=0;
        ...
        try
        {
           ...
           FileReader reader = new FileReader("src/adbproject/SApp_spatialite");
