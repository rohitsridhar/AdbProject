 ...
 * @author rohit
 */
public class MySQL_queries_D3_SA {
     public static void main(String[] args) throws FileNotFoundException, IOException {
       // Connection conn=null;
        ...
        Connection c = null;
       Statement stmt = null;
       PrintStream out = new PrintStream(new FileOutputStream("src/adbproject/output_MySQL_D3_SA.txt"));
   ...
   // System.out.println("\n Connection Successful");
    ...
    FileReader reader = new FileReader("src/adbproject/S_Analysis-MySQL_D3");
