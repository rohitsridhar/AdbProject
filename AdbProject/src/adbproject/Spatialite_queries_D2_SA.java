 ...
 * @author Madhumitha
 */
public class Spatialite_queries_D2_SA {
    /*
 * To change this license header, choose License Headers in Project Properties.
 * To change this template file, choose Tools | Templates
 * and open the template in the editor.
 ...
 */
    ...
    public static void main(String[] args) throws ClassNotFoundException, FileNotFoundException, IOException {
        PrintStream out = new PrintStream(new FileOutputStream("src/adbproject/output_Spatialite_D2_SA.txt"));
        System.setOut(out);
        long startTime=0;
        long stopTime=0;
        ...
        try
        {
           ...
           FileReader reader = new FileReader("src/adbproject/S_Analysis-Spatialite_D2");
