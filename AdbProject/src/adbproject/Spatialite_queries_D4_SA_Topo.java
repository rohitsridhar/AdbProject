 ...
 * @author rohit
 */
public class Spatialite_queries_D4_SA_Topo {
    public static void main(String[] args) throws ClassNotFoundException, FileNotFoundException, IOException {
        PrintStream out = new PrintStream(new FileOutputStream("src/adbproject/output_Spatialite_D4_SA.txt"));
        PrintStream out1 = new PrintStream(new FileOutputStream("src/adbproject/output_Spatialite_D4_topo.txt"));
        System.setOut(out);
        long startTime=0;
        long stopTime=0;
        ...
        try
        {
           ...
           FileReader reader = new FileReader("src/adbproject/S_Analysis-Spatialite_D4");
         ...
         System.setOut(out1);
         FileReader reader1 = new FileReader("src/adbproject/Topo_Spatialite_D4");
