 ...
 */
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Connection c = null;
       Statement stmt = null;
       PrintStream out = new PrintStream(new FileOutputStream("src/adbproject/Sappoutput_mysql.txt"));
      ...
      // Class.forName("org.postgresql.Driver");
         ...
         FileReader reader = new FileReader("src/adbproject/Sapp_Mysql");
