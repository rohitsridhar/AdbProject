 ...
 * @author rohit
 */
public class MySQL_queries_D4_SA_Topo {
    public static void main(String[] args) throws FileNotFoundException, IOException {
       // Connection conn=null;
        ...
        Connection c = null;
       Statement stmt = null;
       PrintStream out = new PrintStream(new FileOutputStream("src/adbproject/output_MySQL_D4_SA.txt"));
       PrintStream out1 = new PrintStream(new FileOutputStream("src/adbproject/output_MySQL_D4_topo.txt")); 
       System.setOut(out);
       try 
       {
   ...
   // System.out.println("\n Connection Successful");
    ...
    FileReader reader = new FileReader("src/adbproject/S_Analysis-MySQL_D4");
         ...
         System.setOut(out1);
         FileReader reader1 = new FileReader("src/adbproject/Topo_MySQL_D4");
