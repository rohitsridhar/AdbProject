 ...
 * @author Madhumitha
 */
public class PostGIS_queries_D2_SA {
    /*
 * To change this license header, choose License Headers in Project Properties.
 * To change this template file, choose Tools | Templates
 * and open the template in the editor.
 ...
 */
   ...
   /**
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Connection c = null;
       Statement stmt = null;
       PrintStream out = new PrintStream(new FileOutputStream("src/adbproject/output_PostGIS_D2_SA.txt"));
       ...
       Class.forName("org.postgresql.Driver");
         ...
         double total;
         double used;
            FileReader reader = new FileReader("src/adbproject/S_Analysis-PostGIS_D2");
